...
@Service
public class DemoHexagonService {
    ...
    public DemoHexagonService(H3Core h3) {
        this.h3 = h3;
    }

    public List<HexagonDto> getHexagons(double minLng, double minLat, double maxLng, double maxLat, int resolution) {
