...
/**
 * Общий хедер всех маршрутов.
 *
 * Логотип стоит в средней колонке сетки `1fr auto 1fr`, поэтому ширина табов
 * слева и содержимого слота справа не сдвигает его с центра.
 *
 * Правый край — пустой слот, а не пропсы: содержимое принадлежит странице,
 * она рендерит туда свои контролы порталом. Иначе каждый новый контрол карты
 * добавлял бы хедеру пропс, всегда пустой на других маршрутах.
 */
